...
class Client:
    ...
    def __init__(self, master, serveraddr, serverport, rtpport, filename):
        ...
        self.playPauseText = StringVar(value='Play ▶')
    ...
    def updateMovie(self, imageFile):
        ...
        self.label = Label(self.master, height=19, image=photo, bg="black")
